  ...
  async function syncProductsFromBackend() {
    try {
      ...
      grid.innerHTML = products.map(p => {
        const img = p.image_url ? (p.image_url.startsWith('http') || p.image_url.startsWith('/') ? p.image_url : '/' + p.image_url) : '/w0ut7ai7_WhatsApp%20Image%202026-06-23%20at%2010.55.35%20AM.jpeg';
        return `
